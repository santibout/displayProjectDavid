     ...
     text-align: center;
      ...
      <div class="main">
        ...
        <div class="print-instructions">
          <h4>Please type or print neatly</h4>
        </div>
        <div class="m-row">
          <div>
            <input type="text" value=${name} />
            <label for="name">Your Present College</label>
          </div>
          <div>
            <input type="text" value=${receiptId} />
